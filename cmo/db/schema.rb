...
ActiveRecord::Schema[7.2].define(version: 2024_09_03_095700) do
  ...
  create_table "player_characters", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id", null: false

  ...
  def activate
    begin
      ...
      if current_user.save
        ...
        logger.debug(character)
        logger.debug(active_character)
        redirect_to characters_path, alert: "Character could not be activated."
      end
    rescue ActiveRecord::RecordNotFound
      redirect_to main_path, alert: "Cannot activate character that is not found."
    end
  end

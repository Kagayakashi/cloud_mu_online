...
module RewardsService
  class ExperienceGainTest < ActiveSupport::TestCase
    ...
    test "should have not enough exp to level up" do
      RewardsService::ExperienceGain.call(monster: @spider, player_character: @character_20)
      assert_equal 20, @character_20.level
    end

    test "should have enough exp to level up" do
      RewardsService::ExperienceGain.call(monster: @spider, player_character: @character_1)
      assert_equal 2, @character_1.level
    end

    test "should level up multiple times from a lot exp" do
      @character_1.level = 1
      RewardsService::ExperienceGain.call(monster: @exp_box, player_character: @character_1)
